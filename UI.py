...
class Variables:
    ...
    def load(self):
        self.text: str = self.main_window.ui.lineEdit.text()
        self.n: int = int(mywindow.is_float(self.main_window.ui.doubleSpinBox))
        self.p: float = mywindow.is_float(self.main_window.ui.doubleSpinBox_2)
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if DEDUG:
            self.ui.doubleSpinBox.setValue(300)  # n
            self.ui.doubleSpinBox_2.setValue(0.75)  # p
